...
export function DateScrubber({ years = [], currentYear, onJump }) {
  ...
  return (
    <div className="hide-scrollbar fixed right-0 top-12 z-[1200] flex h-[calc(100vh-3rem)] w-10 flex-col items-stretch overflow-y-auto bg-black/20 py-2 pb-20 transition-colors hover:bg-black/60 md:w-14 md:pb-2">
      {years.map(({ year }) => {
